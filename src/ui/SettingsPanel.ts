...
const TOGGLES: [keyof SettingsState, string][] = [
  ['orbits', 'Orbit lines'], ['labels', 'Labels'], ['moons', 'Moons'], ['smallBodies', 'Asteroids & comets'], ['spacecraft', 'Spacecraft'], ['belts', 'Asteroid & Kuiper belts'], ['stars', 'Stars & Milky Way'], ['exoplanets', 'Exoplanet systems'], ['deepSky', 'Nebulae & clusters'], ['compact', 'Black holes & neutron stars'], ['galaxy', 'Galaxy model'], ['galaxyMap', 'Galaxy map (artist\'s impression)'], ['structures', 'Heliopause, Oort cloud, Local Bubble…'], ['deepStars', 'Deep star catalogue (+221k stars, 9 MB)'],
];
...
export class SettingsPanel {
  ...
  private render() {
    ...
    this.el.innerHTML = `
      ...
      <div class="credits">Positions: JPL Horizons, JPL SBDB, astronomy-engine, <a href="https://exoplanetarchive.ipac.caltech.edu/" target="_blank" rel="noopener">NASA Exoplanet Archive</a>. Textures: <a href="https://www.solarsystemscope.com/textures/" target="_blank" rel="noopener">Solar System Scope</a> (CC BY 4.0), moon maps NASA/JPL/SSI &amp; LPI (public domain), Milky Way panorama: ESO/S. Brunier (CC BY 4.0), galaxy map: NASA/JPL-Caltech/ESO/R. Hurt (CC BY 4.0), galaxy model: Reid et al. 2019 arm fits, deep-sky data: OpenNGC (CC BY-SA 4.0), nebula photos: Wikimedia Commons (credits in each object's panel), stars: HYG v4.1 &amp; AT-HYG v4.0 (astronexus, CC BY-SA 4.0; Gaia DR3 distances).</div>`;
