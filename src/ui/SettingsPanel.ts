...
const TOGGLES: [keyof SettingsState, string][] = [
  ['orbits', 'Orbit lines'], ['labels', 'Labels'], ['moons', 'Moons'], ['smallBodies', 'Asteroids & comets'], ['spacecraft', 'Spacecraft'], ['belts', 'Asteroid & Kuiper belts'], ['stars', 'Stars & Milky Way'], ['deepStars', 'Deep star catalogue (+221k stars, 9 MB)'],
];
...
export class SettingsPanel {
  ...
  private render() {
    ...
    this.el.innerHTML = `
      ...
      <div class="credits">Positions: JPL Horizons, JPL SBDB, astronomy-engine. Textures: <a href="https://www.solarsystemscope.com/textures/" target="_blank" rel="noopener">Solar System Scope</a> (CC BY 4.0), moon maps NASA/JPL/SSI &amp; LPI (public domain), Milky Way: ESO/S. Brunier (CC BY 4.0), stars: HYG v4.1 &amp; AT-HYG v4.0 (astronexus, CC BY-SA 4.0; Gaia DR3 distances).</div>`;
