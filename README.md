...
- Asteroid belt, Jupiter-region and Kuiper belt / scattered disc as 15,000 Keplerian particles
  propagated on the GPU, and 9,000 real stars (HYG catalogue) over the ESO Milky Way panorama in
...
Star catalogue: HYG v4.1 (CC BY-SA 4.0). Rotation models: IAU Working Group on Cartographic
